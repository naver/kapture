...
│  │  ├─ keypoints.txt                 # type of keypoint (shape and dtype)
│  │  ├─ keypoints.tar                 # instead of regular files, you can use an archive
│  │  │  ├─ map/cam_01/00001.jpg.kpt   # inside the tar, filename is the same as above
...
.reconstruction/keypoints/SIFT/map/cam_01/image000.jpg.kpt (in binary format)
[source,txt]
----
#  x,   y, scale, orient.
[100, 100, 0, 0,
...
Initial version of the format [here](https://github.com/naver/kapture/blob/1.0.17/kapture_format.adoc)
