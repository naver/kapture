...
Note that there are already many datasets (including the ones from visuallocalization.net) directly available in kapture here (no need to manually convert them): https://github.com/naver/kapture/blob/master/doc/tutorial.adoc#download-a-dataset
