...
[source,bash]
----
docker build git://github.com/naver/kapture -t naver/kapture
----

Finally, run unit tests:
[source,bash]
----
docker run --runtime=nvidia -it --rm naver/kapture python3 -m unittest discover -s /opt/kapture/tests
----
