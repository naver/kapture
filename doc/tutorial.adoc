...
NOTE: For this tutorial, you also must have colmap version >=3.6.
On ubuntu 18.04, apt you will install colmap 3.4.
In this case, you will have to compile colmap from source instead.
...
For this tutorial, you must have colmap version >=3.6. see <<install>>
